...
const RegApplication1 = forwardRef((props, ref) => {
    ...
    const handleSubmit = async (event) => {
        ...
        console.log(formData1, formData2, formData3, previews);
        ...
        try {
            ...
            const response = await fetch(`${import.meta.env.VITE_SERVER_URL}/post/saveDatas.php`, {
                method: "POST",
                headers: {
            ...
            if (result.status === "success") {
                ...
                // Set the new status in local storage
                localStorage.setItem("status", "pending");
    
                // Redirect to /regApplication
                window.location.href = "/regApplication";
            } else {
        ...
        <div className="container">
            <div className="review-sections-container">
                ...
                <div className="review-section">
                    ...
                    <p>{localStorage.getItem("program_applied")}</p>
                </div>
